...
describe('Module 4 Project Tests', () => {
  describe('English Language', () => {
   ...
   test(`LABEL_USERNAME is visible`, () => {
     render(<App lang='en' />)
     expect(screen.getByLabelText(txt.en.LABEL_USERNAME))
   })
 ...
 describe('Spanish Language', () => {
   test(`TEXT_HEADING_CREATE_ACCOUNT is visible`, () => {
     render(<App lang="esp" />)
     expect(screen.getByText(text.esp.TEXT_HEADING_CREAT_ACOUNT)).toBeVisible()
   })

   test(`LABEL_USERNAME is visible`, () => {
     render(<App lang='esp' />)
     expect(screen.getByLabelText(txt.esp.LABEL_USERNAME))
   })
